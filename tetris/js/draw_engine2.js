...
class PlayDrawEngine extends PlayGameState {
  constructor() {
    ...
    this.buttons.push(new Button('bottom', 32, gStartX + btn_w * 2 + blockSize, gStartY + blockSize * (board_height + 1), image_size, image_size, 1.0));
...
class DrawEngine extends Observer {
  ...
  __initValue() {
    ...
    this.buttons.push(new Button('bottom', 0, this.startX + btn_w * 2 + blockSize, this.startY + blockSize * (board_height + 1), image_size, image_size, 0.3));
